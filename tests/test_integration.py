...
class TestServiceIntegration(unittest.TestCase):
    ...
    def test_vat_service_integration(self):
        ...
        vat_return = self.vat_service.generate_vat_return_data(
            start_date, end_date)
    ...
    def test_error_monitoring_integration(self):
        ...
        health_report = self.monitoring_service.get_system_health_report(
            hours=1)
    ...
    def test_cross_service_integration(self):
        ...
        vat_calc = self.vat_service.calculate_vat(
            150.0, 'STANDARD')  # Job total
