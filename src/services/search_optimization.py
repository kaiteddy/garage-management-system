...
class SearchOptimizer:
    ...
    def create_search_indexes(self) -> List[str]:
        ...
        try:
            ...
            all_indexes = customer_indexes + vehicle_indexes + \
                job_indexes + invoice_indexes + composite_indexes
            ...
            for table in tables_to_analyze:
                try:
                    ...
                    results.append(
                        f"❌ Failed to analyze table {table}: {str(e)}")
        ...
        try:
            ...
            for view_name, view_sql in views:
                try:
                    ...
                    results.append(
                        f"❌ Failed to create view {view_name}: {str(e)}")
    ...
    def get_search_performance_stats(self) -> dict:
        ...
        try:
            ...
            cursor.execute(
                "SELECT name FROM sqlite_master WHERE type='view' AND name LIKE '%_search_view'")
...
if __name__ == "__main__":
    ...
    print(
        f"✅ Applied {len([r for r in results['optimization'] if '✅' in r])} optimizations")
