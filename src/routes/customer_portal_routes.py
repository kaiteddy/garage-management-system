...
def get_customer_dashboard():
    ...
    try:
        ...
        unread_communications = portal_service.get_customer_communications(
            customer_id, unread_only=True)
...
def get_customer_communications():
    ...
    try:
        ...
        communications = portal_service.get_customer_communications(
            customer_id, unread_only)
...
def mark_communication_read(communication_id):
    ...
    try:
        ...
        result = portal_service.mark_communication_read(
