...
def search_parts():
    ...
    try:
        ...
        if supplier == 'gsf':
            ...
            results = parts_service.search_parts_euro_car_parts(search_term, vehicle_reg)
        else:
            results = parts_service.search_parts_all_suppliers(search_term, vehicle_reg)
...
def add_part_to_catalog():
    ...
    try:
        ...
        required_fields = ['part_number', 'description', 'brand', 'price', 'supplier']
