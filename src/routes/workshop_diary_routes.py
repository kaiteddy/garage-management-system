...
def get_appointments():
    ...
    try:
        ...
        appointments = diary_service.get_appointments_for_period(
            start_date, end_date)
...
def get_scheduling_suggestions():
    ...
    try:
        ...
        estimated_duration = request.args.get(
            'estimated_duration', type=int, default=60)
...
def get_workshop_dashboard():
    ...
    try:
        ...
        today_appointments = diary_service.get_appointments_for_period(
            today, today)
