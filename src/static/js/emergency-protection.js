...
window.printPage = window.printPage || function() {
...
window.showAdminMenu = window.showAdminMenu || function() {
    console.log('👤 Show admin menu called');
    alert('Admin menu coming soon');
};

window.changeSpacing = window.changeSpacing || function(spacing) {
...
window.addEventListener('error', function(event) {
    ...
    errorDiv.style.cssText = 'position: fixed; top: 20px; right: 20px; background: #dc3545; color: white; padding: 15px; border-radius: 5px; z-index: 10000; max-width: 300px; font-family: Arial, sans-serif;';
    errorDiv.innerHTML = '<strong>⚠️ System Error</strong><br>A minor error occurred. The system is still functional.<button onclick="this.parentElement.remove()" style="float: right; background: none; border: none; color: white; cursor: pointer;">×</button>';
