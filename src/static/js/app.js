...
const currentCustomerPage = 1
const currentVehiclePage = 1
const currentCustomerPerPage = 50
const currentVehiclePerPage = 50
const currentCustomerSearch = ''
const currentVehicleSearch = ''
const currentCustomerId = null
const currentVehicleId = null
const currentInvoiceId = null
