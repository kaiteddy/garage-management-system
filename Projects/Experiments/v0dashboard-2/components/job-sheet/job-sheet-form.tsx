            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <PostcodeLookup
                  ...
                  onPostcodeChange={(postcode) => handleCustomerUpdate("postCode", postcode)}
                  onAddressSelect={(address) => {
                    if (address.houseNo) handleCustomerUpdate("houseNumber", address.houseNo)
                    if (address.road) handleCustomerUpdate("road", address.road)
                    if (address.locality) handleCustomerUpdate("locality", address.locality)
                    if (address.town) handleCustomerUpdate("town", address.town)
                    if (address.county) handleCustomerUpdate("county", address.county)
                    if (address.postCode) handleCustomerUpdate("postCode", address.postCode)
                  }}
                  addressData={{
                  ...
                  onAddressChange={(field, value) => {
                    ...
                    handleCustomerUpdate(fieldMap[field], value)
                  }}
                />
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div>
                ...
                <Select
                  value={jobSheet.additionalInfo.technician || ""}
                  onValueChange={(value) => setJobSheet(prev => ({
                    ...prev,
                    additionalInfo: {
                      ...prev.additionalInfo,
                      technician: value
