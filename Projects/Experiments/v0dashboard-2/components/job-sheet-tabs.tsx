                  ...
                  <TableBody>
                    {filterData(customers, searchTerm).map((customer, index) => (
                      <TableRow key={index}>
                        ...
                        <TableCell className="text-currency">{formatCurrency(customer.totalValue)}</TableCell>
                        <TableCell className="text-currency">{formatCurrency(customer.averageJobValue)}</TableCell>
                ...
                <Table>
                  ...
                  <TableBody>
                    {filterData(motReminders, searchTerm).map((reminder, index) => (
                      <TableRow key={index}>
                        <TableCell className="text-registration">{reminder.registration}</TableCell>
                        <TableCell>
                ...
                <Table>
                  ...
                  <TableBody>
                    {filterData(vehicles, searchTerm)
                      ...
                      .map((vehicle, index) => (
                        <TableRow key={index}>
                          <TableCell className="text-registration">{vehicle.registration}</TableCell>
                          <TableCell>
                            <Badge variant="outline">{vehicle.jobCount}</Badge>
                          </TableCell>
                          <TableCell className="text-currency">{formatCurrency(vehicle.totalValue)}</TableCell>
                          <TableCell className="text-currency">{formatCurrency(vehicle.averageJobValue)}</TableCell>
