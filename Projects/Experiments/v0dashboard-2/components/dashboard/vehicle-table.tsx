      ...
      if (response.ok) {
        ...
        if (data.success) {
          ...
          const vehiclesWithStatus = (data.vehicles || []).map((vehicle: any) => ({
            ...vehicle,
            motStatus: getMOTStatus(vehicle.motExpiry || vehicle.motExpiryDate),
          }))
                      ...
                      <TableRow key={vehicle.id}>
                        ...
                        <TableCell>
                          <div>
                            ...
                            <div className="text-sm text-muted-foreground">
                              {vehicle.year} • {vehicle.colour || vehicle.color} • {vehicle.fuelType}
                            </div>
                          </div>
                        </TableCell>
                        <TableCell>
                        ...
                        <TableCell>
                          <div className="space-y-1">
                            ...
                            {(vehicle.motExpiry || vehicle.motExpiryDate) && (
                              <div className="text-xs text-muted-foreground flex items-center gap-1">
                                <Calendar className="h-3 w-3" />
                                {formatDisplayDate(vehicle.motExpiry || vehicle.motExpiryDate)}
                              </div>
                            )}
                          </div>
                        </TableCell>
