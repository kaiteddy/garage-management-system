...
CREATE TABLE IF NOT EXISTS customer_correspondence (
    ...
    CONSTRAINT valid_communication_type CHECK (communication_type IN ('whatsapp', 'sms', 'email', 'phone_call', 'in_person')),
    CONSTRAINT valid_direction CHECK (direction IN ('inbound', 'outbound')),
    CONSTRAINT valid_status CHECK (status IN ('queued', 'sent', 'delivered', 'read', 'failed', 'responded', 'archived'))
);
...
CREATE INDEX IF NOT EXISTS idx_customer_correspondence_customer_id ON customer_correspondence(customer_id);
CREATE INDEX IF NOT EXISTS idx_customer_correspondence_communication_type ON customer_correspondence(communication_type);
CREATE INDEX IF NOT EXISTS idx_customer_correspondence_created_at ON customer_correspondence(created_at);
CREATE INDEX IF NOT EXISTS idx_customer_correspondence_status ON customer_correspondence(status);
CREATE INDEX IF NOT EXISTS idx_customer_correspondence_requires_response ON customer_correspondence(requires_response);

CREATE INDEX IF NOT EXISTS idx_customer_consent_customer_id ON customer_consent(customer_id);
CREATE INDEX IF NOT EXISTS idx_customer_consent_phone_number ON customer_consent(phone_number);

CREATE INDEX IF NOT EXISTS idx_automated_response_rules_active ON automated_response_rules(active);
CREATE INDEX IF NOT EXISTS idx_automated_response_rules_priority ON automated_response_rules(priority);
