...
export async function bulkCheckMOTStatus(
  ...
  const {
    concurrency = 8, // Reduced concurrency to prevent overwhelming the system
    batchSize = 25, // Smaller batch size for better stability
    delayBetweenBatches = 1500, // Longer delay between batches
    onProgress,
  } = options
