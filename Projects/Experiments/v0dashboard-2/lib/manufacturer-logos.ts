...
export function getManufacturerLogo(make: string | null | undefined): ManufacturerLogo {
  ...
  // Using more reliable CDN sources and fallback to text-based logos
  const logoMap: Record<string, ManufacturerLogo> = {
    ...
    'subaru': {
      name: 'Subaru',
      logoUrl: 'https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/subaru.svg',
    ...
    'seat': {
      name: 'SEAT',
      logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/9/92/SEAT_logo.svg',
...
/**
 * Get a fallback logo component for unknown manufacturers
 * @param make - The vehicle manufacturer name
 * @returns A simple text-based logo
 */
