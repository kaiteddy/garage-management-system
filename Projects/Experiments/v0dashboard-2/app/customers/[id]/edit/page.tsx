          ...
          <Card>
            ...
            <CardContent>
              <PostcodeLookup
                ...
                onPostcodeChange={(postcode) => handleInputChange('addressPostCode', postcode)}
                onAddressSelect={(address) => {
                  if (address.houseNo) handleInputChange('addressHouseNo', address.houseNo)
                  if (address.road) handleInputChange('addressRoad', address.road)
                  if (address.locality) handleInputChange('addressLocality', address.locality)
                  if (address.town) handleInputChange('addressTown', address.town)
                  if (address.county) handleInputChange('addressCounty', address.county)
                  if (address.postCode) handleInputChange('addressPostCode', address.postCode)
                }}
                addressData={{
                  houseNo: customer.addressHouseNo || '',
                  road: customer.addressRoad || '',
                  locality: customer.addressLocality || '',
                  town: customer.addressTown || '',
                  county: customer.addressCounty || '',
                  postCode: customer.addressPostCode || ''
                }}
                onAddressChange={(field, value) => {
                  ...
                  handleInputChange(fieldMap[field] as keyof Customer, value)
                }}
                disabled={saving}
              />
            </CardContent>
