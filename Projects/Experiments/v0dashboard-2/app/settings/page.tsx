...
import { Building, Bell, Shield, Database, Mail, CheckCircle } from "lucide-react"
        ...
        <TabsContent value="validation">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure validation rules for job sheets before printing or invoicing</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="p-4 border rounded-lg bg-blue-50 border-blue-200">
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="font-medium text-blue-900">Validation Rules</h4>
                    <p className="text-sm text-blue-700 mt-1">
                      Configure which fields are required before printing or invoicing job sheets.
                      Ensure data completeness and professional documentation standards.
                    </p>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-3 border rounded-lg">
                  <h5 className="font-medium text-sm mb-2">Current Requirements</h5>
                  <ul className="text-xs text-gray-600 space-y-1">
                    <li>• Vehicle registration (Print & Invoice)</li>
                    <li>• Customer name (Print & Invoice)</li>
                    <li>• Customer contact (Print & Invoice)</li>
                    <li>• Vehicle mileage (Print & Invoice)</li>
                    <li>• Complete address (Invoice only)</li>
                  </ul>
                </div>
                ...
                <div className="p-3 border rounded-lg">
                  ...
                  <ul className="text-xs text-gray-600 space-y-1">
                    <li>• Ensures complete documentation</li>
                    <li>• Prevents incomplete job sheets</li>
